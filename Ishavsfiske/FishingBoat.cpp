...
void FishingBoat::mInit()
{
	...
	new Angler::Nodes::SpriteNode(getID() + 0x0106, mCraneRotation, 2, sf::Vector2f(2.0f/3.0f*0.075f, 0.5), sf::Vector2f(560/1500.0f, 318/1600.0f), sf::Vector2f(93/1500.0f, 14/1600.0f));
	...
	new Angler::Nodes::SpriteNode(getID() + 0x0106, mLampRotation, 2, sf::Vector2f(0.5f, 0.5f), sf::Vector2f(503/1500.0f, 231/1600.0f), sf::Vector2f(12/1500.0f, 14/1600.0f));
}
