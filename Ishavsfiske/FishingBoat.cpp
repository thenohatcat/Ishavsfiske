...
void FishingBoat::mInit()
{
	...
	new Angler::Nodes::SpriteNode(getID() + 0x0101, s, 2, sf::Vector2f(0.5f, 0.5f), sf::Vector2f(430/1500.0f, 225/1600.0f), sf::Vector2f(55/1500.0f, 125/1600.0f));
	...
	Angler::Nodes::Translation *rightFishT = new Angler::Nodes::Translation(getID() + 0x0200, s, 0.45f, 0.15f);
	new Angler::Nodes::CollisionNode(0x0201, rightFishT, fishPTS, 0);

	Angler::Nodes::Translation *leftFishT = new Angler::Nodes::Translation(getID() + 0x0200, s, -0.45f, 0.15f);
	new Angler::Nodes::CollisionNode(0x0202, leftFishT, fishPTS, 0);
	...
	Angler::Nodes::Scale *craneS = new Angler::Nodes::Scale(getID() + 0x0104, craneT, 14/1000.0f, 14/1000.0f);
	...
	new Angler::Nodes::SpriteNode(getID() + 0x0106, mCraneRotation, 3, sf::Vector2f(2.0f/3.0f*0.075f, 0.5), sf::Vector2f(560/1500.0f, 318/1600.0f), sf::Vector2f(93/1500.0f, 14/1600.0f));
	...
	Angler::Nodes::Scale *lampS = new Angler::Nodes::Scale(getID() + 0x0104, lampT, 14/1000.0f, 14.0f/1000.0f);
	...
	new Angler::Nodes::SpriteNode(getID() + 0x0106, mLampRotation, 3, sf::Vector2f(0.5f, 0.5f), sf::Vector2f(503/1500.0f, 231/1600.0f), sf::Vector2f(12/1500.0f, 14/1600.0f));
}
